...
sed -i 's/quay.io\/kubernetes-multicluster\/kubefed:${FED_VERSION}/'"${REGISTRY}"'\/kubernetes-multicluster\/kubefed:${FED_VERSION}/g' yaml/_install/2.federation-v${FED_VERSION}.yaml
